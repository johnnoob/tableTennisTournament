            ...
            <div className="flex items-center gap-4">
              <div className="relative">
                <img 
                  src={player.avatar} 
                  alt={player.name} 
                  className={cn("rounded-full object-cover border-2 transition-all group-hover:ring-2 group-hover:ring-offset-2", 
                    isFeatured ? "size-16 border-white/20 group-hover:ring-white" : "size-12 border-transparent group-hover:ring-electric-blue")}
                />
                {player.isVerified && (
                  <div className={cn(
                    "absolute -bottom-1 -right-1 rounded-full p-1",
                    isFeatured ? "bg-electric-blue text-white" : "bg-[#d8e3fb] text-[#111c2d]"
                  )}>
                    <ShieldCheck size={12} />
                  </div>
                )}
