      ...
      <section className="space-y-6">
        ...
        {loading ? (
          <div className="flex flex-col items-center justify-center py-20 gap-4">
            <Loader2 size={32} className="animate-spin text-sapphire-blue" />
            <p className="text-slate-400 font-bold uppercase tracking-widest text-sm">載入對戰紀錄中...</p>
          </div>
        ) : displayed.length === 0 ? (
      ...
      {hasMore && !loading && !searchQuery && (
        <div className="pt-4 pb-12">
          <Button
            ...
            className="w-full rounded-2xl border-none bg-white shadow-sm py-8 text-[11px] font-bold uppercase tracking-widest text-primary-navy hover:bg-slate-50 transition-all font-sans gap-3"
          >
            {loadingMore ? (
